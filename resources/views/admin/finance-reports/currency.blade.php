...
@section('title', app()->isLocale('ar') ? 'تقرير العملات' : 'Currency Report')
@section('page_title', app()->isLocale('ar') ? 'تقرير العملات' : 'Currency Report')
...
@section('content')
    ...
    <div class="space-y-6">
        <div class="bg-white border border-slate-200 rounded-[28px] p-6 shadow-sm">
            ...
            <div class="text-sm text-slate-600 mt-1">{{ $isAr ? 'تجميع حسب currency.' : 'Grouped by currency.' }}</div>
        </div>
