...
@section('content')
    ...
    <div class="max-w-6xl">
        <div class="mb-6">
            ...
            <p class="text-sm text-slate-500 mt-1">تحكم كامل بالهوية، التواصل، وSEO من مكان واحد.</p>
        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white border border-slate-200 rounded-[28px] p-6 shadow-sm">
                        <div class="flex items-start justify-between gap-3 mb-5">
                            ...
                            <span class="text-[11px] px-2 py-1 rounded-full border border-slate-200 bg-slate-50 text-slate-600 font-semibold">
                                Site
                            </span>
                        </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="seo_description" rows="4"
                                    class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm focus:ring-2 focus:ring-black/10 focus:border-black/30 focus:outline-none transition">{{ old('seo_description', $data['seo.meta_description'] ?? '') }}</textarea>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="file" name="site_logo" accept="image/*"
                                    class="block w-full text-sm text-slate-700 file:mr-3 file:rounded-2xl file:border-0 file:bg-slate-900 file:px-4 file:py-2.5 file:text-white file:text-sm file:font-semibold hover:file:bg-slate-800 transition">
                                @error('site_logo')
                                    <div class="text-rose-600 text-xs mt-2">{{ $message }}</div>
                                @enderror
                                ...
                                @if (!empty($data['site.logo']))
                                    <div class="mt-3 flex items-center gap-3">
                                        ...
                                        <div class="text-xs text-slate-500">
                                            اللوجو الحالي، رفع ملف جديد سيستبدله.
                                        </div>
                                    </div>
                                @endif
                            </div>
